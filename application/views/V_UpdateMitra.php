...
<div id="container">
	...
	<?php echo "<h1> Update Mitra </h1>";?>
	<div class="form">
		<form action="<?php echo site_url('C_Garuda/updateAction') ?>" method="post">
			<input type="hidden" value="<?php echo $data_mitra->id_mitra ?>" name ="id_mitra">
			<label for="perusahaan">Perusahaan</label>
			<input type="text" value="<?php echo $data_mitra->perusahaan ?>" name="perusahaan">
			<label for="kemitraan">Kemitraan</label>
			<input type="text" value="<?php echo $data_mitra->kemitraan ?>" name="kemitraan">
			<label for="alamat">Alamat</label>
			<input type="text" value="<?php echo $data_mitra->alamat ?>" name="alamat">
			<label for="email">Email</label>
			<input type="email" value="<?php echo $data_mitra->email ?>" name="email">
			<br><input type="submit" value="update"></center>
		</form>
	</div>
